...
# def test_bgp(otg_api: snappi.Api):
...
#     print(config)
#     otg_api.set_config(config)

#     cs = otg_api.control_state()
#     cs.port.capture.state = cs.port.capture.START
#     otg_api.set_control_state(cs)

#     ps = otg_api.control_state()
#     ps.protocol.all.state = ps.protocol.all.START
#     otg_api.set_control_state(ps)
...
#     otg_api.set_control_state(ts)

#     time.sleep(20)

#     capture_req = otg_api.capture_request()
#     capture_req.port_name = rx1.name
#     with open("../capture.pcap", "wb") as pcap:
#         pcap.write(otg_api.get_capture(capture_req).read())


# def test_bgp_config_from_file(otg_api: snappi.Api):
#     config: snappi.Config = otg_api.config()
